...
setwd("C:/Users/ekhongl/Desktop/BACKUPS/COMMITTED/MFMM")
source('mfmmCpp.R')
...
output <- MFMM( dat, K = 3, multinomial_indices = idx_m, est_cov = TRUE, attempts = 3)
...
options("scipen"=100, "digits"=4)
 ...
 output2 <- MFMM2( dat, K = 3, multinomial_indices = idx_m, est_cov = TRUE)
 diff(output2[[2]])
clust_output$Data_Attributes$estimated_parameters
